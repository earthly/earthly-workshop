...
const servers: Server[] = [
  {
    ...
    gitLink:
      "https://github.com/earthly/earthly-vs-gha/blob/main/rust_server/Earthfile",
    iconColor: "orange",
  },
  {
    ...
    gitLink:
      "https://github.com/earthly/earthly-vs-gha/blob/main/go_server/Earthfile",
    iconColor: "#007f9f",
  },
  {
    ...
    gitLink:
      "https://github.com/earthly/earthly-vs-gha/blob/main/python_server/Earthfile",
    iconColor: "#ffd343",
  },
  {
    ...
    gitLink:
      "https://github.com/earthly/earthly-vs-gha/blob/main/node_server/Earthfile",
    iconColor: "#026e00",
  },
];
